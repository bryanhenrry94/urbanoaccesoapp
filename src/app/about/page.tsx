    ...
    <div className="min-h-screen bg-background-alt">
      ...
      <main className="container mx-auto px-4 py-8 max-w-5xl">
        <h1 className="text-4xl font-bold mb-8 text-center text-text">
          Sobre <span className="text-primary bg-secondary px-2 py-1 rounded-lg transform hover:scale-105 transition-default inline-block">UrbanoAcceso</span>
        </h1>
        ...
        <section className="bg-background shadow-md rounded-lg p-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div className="flex flex-col items-center">
              ...
              <a href="https://www.linkedin.com/in/maria-rodriguez" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary-dark transition-default mt-1">
                LinkedIn
              </a>
            </div>
            <div className="flex flex-col items-center">
              ...
              <a href="https://www.linkedin.com/in/carlos-gomez" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary-dark transition-default mt-1">
                LinkedIn
              </a>
            </div>
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-text-light">Directora de Operaciones</p>
              <a href="https://www.linkedin.com/in/ana-martinez" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary-dark transition-default mt-1">
                LinkedIn
              </a>
            </div>
            <div className="flex flex-col items-center">
              ...
              <a href="https://www.linkedin.com/in/luis-sanchez" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary-dark transition-default mt-1">
                LinkedIn
              </a>
            </div>
          </div>
